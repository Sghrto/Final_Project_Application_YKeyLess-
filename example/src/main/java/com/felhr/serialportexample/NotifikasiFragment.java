...
public class NotifikasiFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_notifikasi_fragment);
    ...
    public class MyHandler extends Handler {
        public final WeakReference<NotifikasiFragment> mActivity;

        public MyHandler(NotifikasiFragment activity) {
